...
BEGIN_ENUM(UPCODES) {
    ...
    DECL_ENUM_ELEMENT(POSTFIX_INCREMENT),
    DECL_ENUM_ELEMENT(POSTFIX_DECREMENT),
    ...
    DECL_ENUM_ELEMENT(COMPARISION_SMALLER),
    DECL_ENUM_ELEMENT(COMPARISION_GREATER_EQUAL),
    DECL_ENUM_ELEMENT(COMPARISION_SMALLER_EQUAL),
